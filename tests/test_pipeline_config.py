...
def test_pipeline_variant_defaults():
    from eval.pipeline_config import PipelineVariant
    v = PipelineVariant(name="minimal", sparse_mode="tfidf", use_reranker=False, use_colbert=False, use_query_rewriter=False)
    assert v.model == "gemini-2.5-pro"
...
def test_pipeline_variant_is_frozen():
    from eval.pipeline_config import PipelineVariant
    v = PipelineVariant(name="frozen", sparse_mode="tfidf", use_reranker=False, use_colbert=False, use_query_rewriter=False)
