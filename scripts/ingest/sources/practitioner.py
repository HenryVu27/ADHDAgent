...
CRAWL_ROOTS = [
    ...
    "https://www.additudemag.com/category/adhd-symptoms-diagnosis/",
    # Understood.org
    "https://www.understood.org/en/articles/understanding-adhd",
    "https://www.understood.org/en/articles/adhd-strategies",
]


class PractitionerConnector:
    source_name = "practitioner"
    ...
    async def fetch(self, query: str = "", max_docs: int = 1000) -> list[RawDocument]:
        ...
        async with aiohttp.ClientSession() as session:
            for root_url in CRAWL_ROOTS:
                await self._crawl(session, root_url, raw_docs, visited, max_docs, depth=0, max_depth=2)
